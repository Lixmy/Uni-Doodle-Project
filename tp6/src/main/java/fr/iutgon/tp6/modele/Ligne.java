...
public class Ligne {
  ...
  public Ligne(int qte, Produit produit) {
    ...
    NumberExpression prix = Bindings.selectFloat(this.produit, "prix");
    NumberExpression tva = Bindings.selectFloat(this.produit, "tva");
    totalHT = Bindings.multiply(this.qte, prix);
    totalTTC = Bindings.multiply(totalHT, tva);
  }
